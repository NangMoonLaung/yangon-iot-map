...
# Sensor node sample data
data = [
    {"name": "Sensor 1", "lat": 16.8409, "lon": 96.1735, "value": 25},
    {"name": "Sensor 2", "lat": 16.8500, "lon": 96.1700, "value": 30},
]

df = pd.DataFrame(data)

# Center map at Yangon
m = folium.Map(location=[16.8409, 96.1735], zoom_start=13)
